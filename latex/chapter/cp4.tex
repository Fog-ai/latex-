    ...
    \begin{equation}
        \begin{aligned}
            E[V^2] &= \frac{1}{w}\sum_{\beta=0}^{w-1} E[V_\beta^2] \\
                   &= \frac{1}{w}\sum_{\beta=0}^{w-1} \left[\beta^2\left(p + \frac{1-p}{M}\right)^2 + \beta p(1-p)\frac{(M-1)^2}{M^2} \right. \\
                   &\quad \left. + 2\beta\left(p + \frac{1-p}{M}\right) + 1\right] \\
                   &= \frac{(w-1)(2w-1)}{6}\left(p + \frac{1-p}{M}\right)^2 + \frac{(w-1)p(1-p)(M-1)^2}{2M^2} \\
                   &\quad + (w-1)\left(p + \frac{1-p}{M}\right) + 1 \\
